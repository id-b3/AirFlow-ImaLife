...
if __name__ == "__main__":
    ...
    parser.add_argument('input_file', type=str, help="Input the nifti file for correction of headers.")
    parser.add_argument('input_volume', type=str, help="Volume nifti file containing the correct headers.")
