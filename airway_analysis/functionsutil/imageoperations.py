...
def compute_boundbox_around_mask(in_image: np.ndarray, num_voxels_buffer: int) -> BoundBoxType:
    ...
    return ((out_boundbox[0][0] - num_voxels_buffer, out_boundbox[0][1] + num_voxels_buffer),
            (out_boundbox[1][0] - num_voxels_buffer, out_boundbox[1][1] + num_voxels_buffer),
            (out_boundbox[2][0] - num_voxels_buffer, out_boundbox[2][1] + num_voxels_buffer))


def compute_cropped_image(in_image: np.ndarray, in_crop_boundbox: BoundBoxType) -> np.ndarray:
