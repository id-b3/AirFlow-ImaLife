...
def main(args):
    ...
    axarr[0].imshow(np.rot90(air_seg.image.sum(axis=0)), interpolation="hanning", cmap="gray")
    axarr[1].imshow(np.rot90(air_seg.image.sum(axis=1)), interpolation="hanning", cmap="gray")
