...
CALL="/bronchinet/scripts/util/fix_transfer_syntax.py ${INPUT} ${INPUTFILE}"
eval "$CALL"
...
/bronchinet/scripts/opfront_scripts/opfront_one_scan.sh ${NIFTIIMG}/*.nii.gz ${RESDIR}/*.nii.gz "${OUTPUTFOLDER}" "-i 15 -o 15 -I 2 -O 2 -d 0 -b 0.4 -k 0.5 -r 0.7 -c 17 -e 0.7 -K 0"
