...
class PhantomTrainer:
    ...
    def process_phantom(self, run_number: int,
        ...
        for split_path in Path(split_out_dir).iterdir():
            ...
            subprocess.run([measure_split, str(self.volume), inner_vol, outer_vol, ])
    ...
    def get_split_vol(self, split_dir: Path) -> tuple:
        ...
        root_out = split_dir / self.volume.stem
        return str((root_out / "_surface-1.nii.gz").resolve()), str((root_out / "_surface0.nii.gz").resolve())
