...
IN_VOLSEG_ISO="${OUT_DIR}/COPDGene_Phantom_Qr59_Lumen_iso05.nii.gz"
BOXES_REGIONS="${OUT_DIR}/boundboxes_regions_phantom.pkl"
...
CALL="python3 ${SCR_CALC_BOXES} -i $IN_VOLSEG_ISO -o $BOXES_REGIONS"
echo -e "\n$CALL"
eval "$CALL"

echo -e "\nSplit segmentation in 8 regions in phantom:"
CALL="python3 ${SCR_SPLIT_SEG} -i $IN_VOLSEG_ISO -ib $BOXES_REGIONS -o $OUT_DIR"
echo -e "\n$CALL"
eval "$CALL"
